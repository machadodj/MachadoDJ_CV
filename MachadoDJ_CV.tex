...
\item \textbf{Bioinformaticist}, \textbf{zoologist}, and \textbf{marine biologist} with a strong background in \textbf{parasitology}, \textbf{virology}, \textbf{biostatistics}, \textbf{data science}, \textbf{computational biology}, and \textbf{phylogenetics}.
...
\item 15+ years of experience in \textbf{molecular biology} labs, developing and optimizing \textbf{high-throughput sequencing} protocols (e.g., Illumina, PacBio, Hi-C, GWAS, and RNA-Seq).

\item 8+ years of experience in \textbf{machine learning} (e.g., PyTorch, TensorFlow), \textbf{big data analyses}, \textbf{mathematical modeling}, \textbf{high-throughput data processing}, and \textbf{data mining algorithms} to solve practical problems in emerging infectious diseases research.
...
\cventry{2026--2028}
    ...
    {\href{https://cladistics.org/}{cladistics.org}}
    {}
    {}

\cventry{2025--current}
    {Elected Fellow}
    {The Willi Hennig Society}
    {\href{https://cladistics.org/}{cladistics.org}}
    {}
...
\subsection{2026}
	...
	{\setlength{\parskip}{.5em}\renewcommand{\baselinestretch}{2.0}\begin{hangparas}{.25in}{1}
        ...
        Rodrigues, F. M., Prieto-Oliveira, P., Zukurov, J. P., Alkmim, W. T., Soane, M. M., Camargo, M., Sanabani, S. S., Kallas, E. G., Sucupira, M. C., Diaz, R. S., Janini, L. M. \& \textbf{Jacob Machado, D.} (2026). Multiple Infections, Recombination, and Hypermutation During a 12-Month Prospective Study of Five HIV-1 Infected Individuals. \textit{Microbiology Research}, \textbf{17(2)}, 30. \href{https://doi.org/10.3390/microbiolres17020030}{10.3390/microbiolres17020030}.
...
\subsection{2025}
	...
	{\setlength{\parskip}{.5em}\renewcommand{\baselinestretch}{2.0}\begin{hangparas}{.25in}{1}
        ...
        Alves, P. V., da Silva, R. J., Janies, D., Taylor, W., Harris, A., New, G., \& \textbf{Jacob Machado, D.} (2025). Mining natural history collections for molecular treasures: mitogenomes and nuclear ribosomal transcription units of proteocephalid tapeworms (Onchoproteocephalidea) via genome skimming. International Journal for Parasitology. DOI: \href{https://doi.org/10.1016/j.ijpara.2025.12.007}{10.1016/j.ijpara.2025.12.007}.

        Márquez, R., \textbf{Jacob Machado, D.}, Nouri, R., Gendreau, K. L., Janies, D., Saporito, R. A., Kronforst, M. R., \& Grant, T. (2025). A draft genome assembly for the dart-poison frog Phyllobates terribilis. Gigabyte, 2025, gigabyte157-0. DOI: \href{https://doi.org/10.46471/gigabyte.157}{10.46471/gigabyte.157}.
...
\subsection{2024}
	...
	{\setlength{\parskip}{.5em}\renewcommand{\baselinestretch}{2.0}\begin{hangparas}{.25in}{1}
		...
		Nouri, R., Mashanov, V., Harris, A., New, G., Taylor, W., Janies, D., ... \& \textbf{Jacob Machado, D.} (2024). Unveiling putative modulators of mutable collagenous tissue in the brittle star \textit{Ophiomastix wendtii}: an RNA-Seq analysis. \textit{BMC Genomics}, 25(1), 1013. DOI: \href{https://doi.org/10.1186/s12864-024-10926-7}{10.1186/s12864-024-10926-7}.
...
\subsection{2023}
	...
	{\setlength{\parskip}{.5em}\renewcommand{\baselinestretch}{2.0}\begin{hangparas}{.25in}{1}
		...
		Mashanov, V. S., Ademiluyi, S., \textbf{Jacob Machado, D.}, Reid, R., and Janies, D. (2023). Echinoderm radial glia in adult cell renewal, indeterminate growth, and regeneration. \textit{Frontiers in Neural Circuits}, \textbf{17}, 1258370. DOI: \href{https://doi.org/10.3389/fncir.2023.1258370}{10.3389/fncir.2023.1258370}.
...
\cventry{2024--2027}
    {CNPq/MCTI: ``ARISE in HPC: Artificial Intelligence for Recombination Identification and Surveillance in Epidemiology in a CAD Environment''}
    {Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq)}
    {Brazil}
    {CNPq/MCTI/FNDCT No. 22/2024 -- Programa Conhecimento Brasil}
    {R\$~219.591,00}

\cventry{May--Aug., 2025}
    {AI in Education: ``Building AI-Readiness Across Bioinformatics Core Courses''}
    {University of North Carolina at Charlotte}
    {U.S.A.}
    {internal grant}
    {US\$~10,000.00}{}
...
\vspace{.5em}
	\subsection{\textsc{In prep.}}
\vspace{.5em}

\cventry{2026--2028}% Time
    {Comparative genomics, biomechanics, and evolution of panarthropod prey-capture bioadhesives}% Title
    {National Science Foundation (NSF), Division of Integrative Organismal Systems (IOS), Physiological Mechanisms and Biomechanics (PMB)}% Source
    {United States}% Place
    {In development / not submitted}% Number
    {Amount TBD}% Amount

\cventry{Oct. 2025 -- Jan. 2026}% Time
    {Building Inclusive Pathways to Computing and AI Careers for Domestic Talents: A Data-Driven K--16 Strategy}% Title
    {National Science Foundation (STEM K--12)}% Source
    {USA}% Place
    {In development / not submitted}% Number
    {Not known}% Amount

\cventry{Dec. 2025 -- Jan. 2026}% Time
    {SuccessAI: An Agentic AI Framework for Actionable, Visualization-Rich Student Success Analytics}% Title
    {National Science Foundation (program TBD)}% Source
    {USA}% Place
    {In preparation}% Number
    {Not known}% Amount

\vspace{.5em}
	\subsection{\textsc{Not Funded}}
\vspace{.5em}

\cventry{Oct. 2025 -- Nov. 2025}% Time
    {Undo ``Stuck in the Shallow End'': Mixed-Methods and Cross-Campus Computing Education Initiative}% Title
    {Gambrell Faculty Fellowship, UNC Charlotte}% Source
    {Charlotte, NC, USA}% Place
    {Submitted, not funded}% Number
    {Not known}% Amount

\cventry{2024 -- 2025}% Time
    {Undo ``Stuck in the Shallow End'': Student Success and Computing Education}% Title
    {American Educational Research Association (AERA) Student Success Grant}% Source
    {USA}% Place
    {Submitted (outcome not documented)}% Number
    {Not known}% Amount
...
\cventry{July. 22, 2025}
    {XLII Annual Meeting of the Willi Hennig Society}
    {The Chinese University of Hong Kong, HKSAR}
    {Hong Kong, China}
    {}
    {
        \textbullet~Description: In July 2025, Dr. Jacob Machado organized and convened an international symposium titled ``Phylogenetics \& Public Health: Lessons from COVID-19 and Emerging Threats'' at the XLII Annual Meeting of the Willi Hennig Society in Hong Kong. The symposium brought together international researchers to discuss applications of phylogenetics to public health, including SARS-CoV-2, mpox, H5N1, and papillomaviruses. Jacob Machado served as symposium organizer and moderator, opening and closing the session and coordinating speakers, scope, and scientific focus. The symposium emphasized methodological rigor, best practices in phylogenetic inference, and the role of evolutionary systematics in responding to emerging infectious disease threats.\\
        \textbullet~Event homepage: \url{https://cladistics.org/xlii-annual-meeting-2025}
    }
...
\cventry{July 24, 2025}
    {XLII Annual Meeting of the Willi Hennig Society}
    {The Chinese University of Hong Kong}
    {Hong Kong SAR, China}
    {}
    {
        \textbullet~Title: Beetles, bytes, and branches: Integrating artificial intelligence into the taxonomy and phylogenetics of Passalidae\\
        \textbullet~Authors: Larry Jiménez-Ferbans, Cristian Beza-Beza, Anastasiia Duchenko, Aram Mikaelyan, and Jacob Machado, D.\\
        \textbullet~Format: Oral presentation\\
        \textbullet~Conference website: \url{https://willi-hennig-society.org/meetings/2025}
    }

\cventry{July 23, 2025}
    {XLII Annual Meeting of the Willi Hennig Society}
    {The Chinese University of Hong Kong}
    {Hong Kong SAR, China}
    {}
    {
        \textbullet~Title: Advancing phylogenetics for health threats: Lessons from the COVID-19 pandemic and beyond\\
        \textbullet~Authors: Omkar Marne and Jacob Machado, D.\\
        \textbullet~Format: Oral presentation (Symposium 1: Phylogenetics \& Public Health)\\
        \textbullet~Conference website: \url{https://willi-hennig-society.org/meetings/2025}
    }

\cventry{June 7, 2025}
    {100th Annual Meeting of the American Society of Parasitologists}
    {Winston-Salem, NC}
    {USA}
    {}
    {
        \textbullet~Title: AI-driven predictions of phylogenetic trees from zoogeographical data in dactylogyrids (Platyhelminthes: Monogenea)\\
        \textbullet~Authors: Jacob Machado, D., Aline A. Acosta, and Anastasiia Duchenko\\
        \textbullet~Format: Oral presentation\\
        \textbullet~Conference website: \url{https://aspmeetings.wixsite.com/2025}
    }

\cventry{May 29, 2025}
    {Society for the Preservation of Natural History Collections (SPNHC) Annual Meeting}
    {Lawrence, KS}
    {USA}
    {}
    {
        \textbullet~Title: Simplifying specimen loans: Ten simple rules for researchers\\
        \textbullet~Authors: Giovanna Yumi Scorsim Omura and Jacob Machado, D.\\
        \textbullet~Format: Oral presentation\\
        \textbullet~Conference website: \url{https://spnhc2025.ku.edu/}
    }

\cventry{April 17, 2025}
    {UNC Charlotte Undergraduate Research Conference (URC)}
    {Charlotte, NC}
    {USA}
    {}
    {
        \textbullet~Title: FLAVi 2: Increasing Efficiency and Accessibility of Flaviviridae Genome Annotation\\
        \textbullet~Authors: Cayden Jacobsen and Jacob Machado, D.\\
        \textbullet~Format: Oral presentation\\
        \textbullet~Video: \url{https://www.youtube.com/watch?v=k6bCMXNy_NQ}
    }

\cventry{March 27, 2025}
    {Postdoctoral Readiness to Enter the Professorship Program (PREPP)}
    {UNC System (online)}
    {USA}
    {}
    {
        \textbullet~Title: Preparing for the Faculty Interview\\
        \textbullet~Authors: Jacob Machado, D., Skylar Hopkins, Ebony Jones, and Maria Rodgers\\
        \textbullet~Format: Invited panel presentation\\
        \textbullet~Program homepage: \url{https://grad.ncsu.edu/professional-development/opa/professional-development/}
    }

\cventry{January 5, 2025}
    {Annual Meeting of the Society for Integrative and Comparative Biology (SICB)}
    {Atlanta, GA}
    {USA}
    {}
    {
        \textbullet~Title: Unveiling the modulators of mutable collagenous tissue in the brittle star \textit{Ophiomastix wendtii}: An RNA-Seq analysis\\
        \textbullet~Authors: Reyhaneh Nouri, Vladimir Mashanov, and Jacob Machado, D.\\
        \textbullet~Format: Oral presentation\\
        \textbullet~Slides: \url{https://gitlab.com/phyloinformatics-presentations/20241121/-/blob/main/reyhaneh_nouri/20250105_Nouri.pdf}
    }
...
\cventry{April 23, 2025}
    {Mutations in Space and Time Conference}
    {Broad Discovery Center, Cambridge, MA}
    {USA}
    {}
    {
        \textbullet~Title: Automated Protocol for Testing Crucial Mutations in Coronaviruses Using AI: Insights into Immune Escape and Resistance\\
        \textbullet~Authors: Anastasiia Duchenko, Daniel Janies, and Jacob Machado, D.\\
        \textbullet~Format: Poster presentation\\
        \textbullet~Project page: \url{https://gitlab.com/staisyelash/2025_mutationsintimeandspace_duchenko}
    }
...
\cventry{2024--current}
	{Instructor (Faculty)}
	{University of North Carolina at Charlotte (UNC Charlotte)}
	{Bioinformatics Programming II (BINF-6112/8112)}
	{3 credits (Spring \& Fall)}
	{
		\textbullet~Shell scripting and high-performance computing training\\
        \textbullet~Python programming for handling biological data\\
	}
...
\cventry{2017 \& 2025}
	{Invited Lecturer}
	{University of Magdalena}{Introduction to bioinformatics}
	{40 hours)}
	{
		\textbullet~Taught lecture and lab to over 20 students, including undergraduate and graduate students, postdocs, staff, and faculty\\
...
\cventry{2025--current}
	{Instructor (Faculty)}
	{University of North Carolina at Charlotte (UNC Charlotte)}
	{Intro to Computer Science II (ITSC1213-001)}
	{3 credits (Summer)}
	{
		\textbullet~Best practices in computer programming\\
        \textbullet~Git and GitHub\\
        \textbullet~Java programming\\
	}
...
The Phyloinformatics Lab currently has four doctoral students from the \href{https://cci.charlotte.edu/academics/bioinformatics/bcb-phd-program/}{Bioinformatics and Computational Biology (BCB) Ph.D. Program}.\\

Please visit \href{https://phyloinformatics.com/people/}{phyloinformatics.com/people} for current information on my current team members and alumni.\\
...
\cventry{2022--2025}
    ...
    {USA}
        {
            \textbullet~Paula Prieto Oliveira (\textit{postdoc})\\
            \textbullet~Philippe Vieira Alves (\textit{postdoc})\\
            \textbullet~Isha Jain (\textit{Master's})\\
            \textbullet~Prudvi Raj Ragi (\textit{Master's})\\
            \textbullet~Shivam Patel (\textit{Master's})\\
            \textbullet~Tulasi Arla (\textit{Master's})\\
            \textbullet~Vedika Judyani (\textit{Master's})\\
            \textbullet~Drashti Mehta (\textit{Master's})\\
            \textbullet~Bou Haidara (\textit{Master's})\\
            \textbullet~Hugo de Paula Oliveira (\textit{Master's})\\
            \textbullet~Johannes Schultheis (\textit{Master's})\\
            \textbullet~Amariah Robinson (\textit{undergrad})\\
            \textbullet~Manish Kota (\textit{undergrad})\\
            \textbullet~Cayden Jacobsen (\textit{undergrad})\\
            \textbullet~Hannah Zeru (\textit{undergrad})\\
            \textbullet~Cameron Jones (\textit{undergrad})\\
        }
...
% 	\textbullet~Project: ``Combining RNA-seq and machine learning to unravel the evolution of tetrodotoxin (TTX) defense in \textit{Taricha granulosa}''\\
...
Dr. Jacob Machado has extensive experience mentoring undergraduate and graduate students prior to the Phyloinformatics Lab.
...
\section{Editorial Roles}
    ...
    \cvline{2026--current}{\textbf{Editor}: Cladistics}
...
\section{Reviews}
    ...
    Throughout my career, I have completed 65 reviews in 28 academic journals:\\
    ...
    \begin{multicols}{2}{\footnotesize
        ...
        \cvline{1}{Infectious Disease Reports}
        \cvline{1}{Life}
...
\subsection{Languages}
    ...
    \cvlanguage{Hebrew}{Beginer}{}
    \cvlanguage{Latin}{Beginer}{}
...
\subsection{Software Development}
	...
	\cvline{Web}
		{\href{https://grant.ib.usp.br/anfibios/researchSoftware.html}{grant.ib.usp.br/anfibios} \& \href{https://phyloinformatics.com/resources/}{phyloinformatics.com}}
...
\section{Immigration \& Citizenship}
